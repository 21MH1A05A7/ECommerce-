            ...
            {productItem.map(function(item){
              ...
              <div className={`relative block sm:flex-row flex flex-col rounded-lg w-full bg-[#171717] overflow-hidden border border-1 h-[400px] sm:h-full `}>
                    ...
                    <div className="pb-1 sm:pb-5 text-left sm:text-right rounded-lg border-1 sm:space-y-4 sm:relative">
                        <h1 className="text-white font-medium hidden sm:block pt-5 sm:pr-2">{item.type}<span className="text-white text-2xl "> |</span></h1>
                        ...
                        <Link to={{pathname:'/Item',state:{title:'Nike Air Jordan'}}}><button className="text-white border border-white px-3 py-2 rounded-lg w-full">Explore</button></Link>
                            <button className="text-black font-medium border border-white px-3 py-2 rounded-lg w-full bg-[#EF9A53]">Add to Cart</button>
                        </div>
                        <p className="text-white absolute right-24 pt-2 w-60 opacity-30">Free Delivery by Mugiwara</p>
                    </div>
