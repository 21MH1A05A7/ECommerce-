            ...
            <div className="relative w-full rounded-2xl border-2 shadow-lg shadow-[#171717] block lg:flex flex-1">
                ...
                <div className="w-full sm:ml-10 sm:mt-10 sm:w-[500px] h-full space-y-5">
                    ...
                    <div className="pt-7 sm:pt-10 px-1 sm:px-0 flex sm:w-[550px] space-x-2">
                        <input type="text" placeholder="Search your brand" className="sm:ml-6 p-2 w-full border focus:outline-none ring-1 rounded-full "/>
                        <button className="px-4 border border-black rounded-full bg-[#EF9A53]">Check</button>
                    </div>
                    <div className="flex flex-row px-3 sm:px-0 sm:ml-6 space-x-5 sm:pt-4">
                        <a href="www.nike.com" className="rounded-full border-[2px] border-black p-2 bg-[#CCC8AA]"><img src={nike} alt="" className="w-10 rounded-full"/></a>
                ...
                <div className="flex space-x-6 z-5 sm:space-x-0 sm:block absolute space-y-0 sm:space-y-4 right-[70px] bottom-36 sm:right-10 sm:top-14">
